...
def get_station_info(station):
    ...
    driver = Driver()
    url = "https://search.naver.com/search.naver?where=nexearch&sm=top_hty&fbm=1&ie=utf9&query="
