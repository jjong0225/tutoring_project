...
void manage_my_info(int& sub_command, int& subb_command, bool& isDelete, UserTreeNode* user2, string& cname, bool& savecheck, string& cstation, MetroTreeNode* metro_root, string& name1, int& time1, int& time2, string& station, int& rmschedule, string& rmname, UserTreeNode* user_root ) {
...
void login_menu(string& fname, string& cname, string& password, UserTreeNode* user_root, int& command, bool& isDelete, int& sub_command, int& subb_command, bool& savecheck, string& station, string& cstation, MetroTreeNode* metro_root, string& name1, int& time1, int& time2, int& rmschedule, string& rmname, int& fstation) {
		...
		if(log != nullptr){
			...
			while(command != 4 && !isDelete){
				...
				cout<< "1. 유저 데이터 관리 -> 나의 정보 관리"<< endl;
				cout<< "2. 스케줄 관리"<< endl;
				...
				{
					case 1:{
						manage_my_info(sub_command, subb_command, isDelete, user2, cname, savecheck, cstation, metro_root, name1, time1, time2, station, rmschedule, rmname, user_root);	
					}	
					case 2:
					{  
					...
					case 3: {
								...
								cout<<"스케줄 이름: ";
								cin>>name;
								cout<<"스케줄 시작 시간[HHMM : 2400]: ";
								cin>>start_time;
								cout<< "스케줄 종료 시간[HHMM : 2400]: "; 
								cin>>end_time;
...
int main()
{
    ...
    while(command_m != 4){
        ...
        cout << "[Mange Your Schedule]" << endl;
        cout<< "1. 로그인"<< endl;
        cout<< "2. 회원가입"<< endl;
		cout<< "3. 프로그램 설명 보기"<< endl;
        cout<< "4. 프로그램 종료"<< endl;
        cin >> command_m;
        ...
        switch(command_m){
            case 1:{
				...
				login_menu(fname, cname, password, user_root, command, isDelete, sub_command,subb_command, savecheck, station, cstation, metro_root, name1, time1, time2, rmschedule, rmname, fstation); 
			   break;
            }
            case 2:{
                cout << "-------------------------------------------------" <<endl;
